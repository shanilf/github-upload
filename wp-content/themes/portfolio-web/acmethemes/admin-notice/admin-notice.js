...
jQuery( document ).ready( function ( $ ) {
	...
	$( '.at-gsm-btn' ).click( function ( e ) {
		...
		$( this ).text( portfolio_web_adi_install.btn_text );
		...
		$.ajax({
			...
			data: {
				...
				security : portfolio_web_adi_install.nonce,
				...
				setTimeout(function(){
					$.ajax({
						...
						success:function( response ) {
							...
							redirect_uri         = portfolio_web_adi_install.adminurl+'/themes.php?page=advanced-import&browse=all&at-gsm-hide-notice=welcome';
