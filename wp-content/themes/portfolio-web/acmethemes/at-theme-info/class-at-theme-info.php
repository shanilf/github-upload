    ...
    class Portfolio_Web_Theme_Info{
        ...
        public function at_theme_info_screen() {
            ...
            if (
                ...
                $notice_nag = get_option( 'portfolio_web_admin_notice_welcome' );
                if ( ! $notice_nag ) {
                    echo '<div class="at-gsm-notice">
                        <small class="plugin-install-notice">'.esc_html__('Clicking the button below will install and activate the Advanced Import plugin.','portfolio-web').'</small>
                        <a class="at-gsm-btn button button-primary button-hero" href="#" data-name="" data-slug="" aria-label="'.esc_html__('Get started with Portfolio Web','portfolio-web').'">
                         '.esc_html__('Get started with Portfolio Web','portfolio-web').'                   
                         </a>
                    </div>';
                }
