    ...
    at_document.ready( function() {
        ...
        function at_build_hide_unnecessary_meta() {
            var page_template = $('#page_template'),
                lportfolio_web_template_builder_metabox = $('#portfolio_web_template_builder_metabox'),
                portfolio_web_sidebar_layout = $('#portfolio_web_sidebar_layout'),
                portfolio_web_meta_fields = $('#portfolio_web_meta_fields'),
            ...
            if( valueSelected === 'page-templates/template-builder.php' ){
                lportfolio_web_template_builder_metabox.removeClass('hidden');
                portfolio_web_sidebar_layout.addClass('hidden');
                portfolio_web_meta_fields.addClass('hidden');
                postimagediv.addClass('hidden');
            }
            else{
                lportfolio_web_template_builder_metabox.addClass('hidden');
                portfolio_web_sidebar_layout.removeClass('hidden');
                portfolio_web_meta_fields.removeClass('hidden');
